...
u8 AccessAddr[4] = {0x8e,0x6e,0x82,0x94};
u8 PayLoad1[32]={
...
void SRRC_PRBS9Test(unsigned char freq)
{
    ...
    SPI_Write_Buffer(0x10,AccessAddr,4);
    SPI_Write_Reg(0x20|0x03,0x02);
    SPI_Write_Reg(0x20|0x00,0x0e);
    SPI_Write_Reg(0x20|0x06,0x06); //for cont wave

    SPI_Write_Reg(0xe1,0xff);
	SPI_Write_Buffer(0xa0,PayLoad1,32);
    SPI_Write_Buffer(0xa0,PayLoad2,10);
...
#if 0//Spurious spectrum test
void SRCCSpuriousTest(unsigned char freq)
{
    unsigned long delay=0x14000;
    unsigned char temp[6];
    ...
    SPI_Write_Reg(0x20|0x00,0x0e);
    SPI_Write_Reg(0x20|0x06,0x96); //for cont wave
    SPI_Write_Reg(0xe3,0xff);

    SPI_Write_Reg(0x50, 0x53);
    SPI_Write_Reg(0x20|0x16, 0x8e);
    SPI_Write_Reg(0x50, 0x51);
    SPI_Write_Reg(0x20|0x06,0x06);
    SPI_Write_Reg(0x50, 0x53);
